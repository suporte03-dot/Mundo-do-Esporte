  ...
  return (
    <SvgFrame className="mg-illust--back">
      ...
      <path
        ...
        strokeLinecap="round"
      />
      {/* torso outline — wide top, tapered waist, blunt base */}
      <path
      ...
      {/* lat flares — curved muscle, not straight veins */}
...
export function IllustMobility() {
  return (
    <SvgFrame className="mg-illust--mobility">
      ...
      />
      <path
        d="M36 70 C48 62 72 62 84 70"
        stroke="currentColor"
        strokeWidth={SW}
        strokeLinecap="round"
      />
      <path
        d="M44 108 C52 116 68 116 76 108"
        stroke="currentColor"
        strokeWidth={SW}
        strokeLinecap="round"
      />
